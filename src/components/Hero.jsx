  ...
  return (
    <section className="h-screen relative text-[#eee] bg-[#010101] overflow-hidden">
      {/* <a
        ...
        target="_blank"
      >
        <button className="fixed right-[15px] bottom-[15px] z-50 bg-[greenyellow] p-[10px] text-[1.3rem] rounded-[5px] cursor-pointer tracking-[0.5px] text-[#04043b]">
          whatsapp
        </button>
      </a> */}
      ...
      <div>
        <div className="absolute inset-0 overflow-hidden  duration-[0.5s]   ">
          ...
          <div className="absolute left-[10%] top-[20%] w-[500px] max-w-[80%] z-10 contrast-200 drop-shadow-2xl ">
            <p className="uppercase tracking-[10px] translate-Y-[30px] blur-[20px] opacity-0 animate-show-content">
              Gudauri Paragliding
            </p>
            <h2 className="text-[100px] m-0 translate-Y-[30px] blur-[20px] opacity-0 animate-show-content  max-sm:text-[60px] font-bold">
              {choosenSeason.title}
            </h2>
