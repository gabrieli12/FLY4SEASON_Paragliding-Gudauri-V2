...
function About() {
  return (
    <>
      <title>About Us - FLY4SEASON - Paragliding in Gudauri</title>
      <meta
        name="description"
      ...
      <main className="w-full ">
        <section className="relative w-full h-screen flex justify-center items-center flex-col gap-14 p-16 max-md:px-5 max-sm:gap-10 ">
          ...
          <h2 className="text-xl text-amber-50 z-10 text-center max-w-3/4 tracking-wide leading-9 max-lg:max-w-full max-md:text-lg max-md:leading-8 max-sm:text-sm max-sm:leading-6 ">
            ...
            paragliding flights in Gudauri and Ananuri. This company was formed
            by professionals united under one thought. For us, this field, in
            ...
            is to create a safe, unforgettable and emotional service for all
            those who want it, and we record these emotions with video recording
            as a memory for them. Be safe fly with us!
          </h2>
        </section>
        ...
        <section className=" flex justify-center items-center p-20 max-sm:px-1 ">
          <div className="grid grid-cols-2 max-w-[1300px] gap-10 max-lg:grid-cols-1 max-lg:w-[500px] max-sm:w-full ">
            <img
              ...
              src="/images/licence/lasha.jpg"
              alt=""
            />
            <img
              className="object-cover rounded-xl"
              src="/images/licence/licence.jpg"
              alt=""
            />
            <img
              className="object-cover rounded-xl"
              src="/images/licence/kasha.png"
              alt=""
            />
            <img
              className="object-cover rounded-xl"
              src="/images/licence/licence2.png"
              alt=""
            />
          </div>
        </section>
